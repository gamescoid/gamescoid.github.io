...
window.addEventListener("scroll",l=>{var s=document.getElementById("jsScroll");window.scrollY>200?s.classList.add("visible"):s.classList.remove("visible")});function scrollToTop(){window.scrollTo({top:0,behavior:"smooth"})}
